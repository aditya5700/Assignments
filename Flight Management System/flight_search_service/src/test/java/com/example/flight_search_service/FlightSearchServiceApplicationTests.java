...
class FlightSearchServiceApplicationTests {
	...
	protected void setFlight() {
		...
		flight.setDepartureDate(LocalDate.parse("2022-04-16"));
		flight.setArivalTime(LocalTime.parse("16:00:00"));
		flight.setSeats(80);
		...
		flight2.setDepartureDate(LocalDate.parse("2022-04-16"));
		flight2.setArivalTime(LocalTime.parse("19:00:00"));
		flight2.setSeats(80);
