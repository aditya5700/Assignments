...
class AirportServiceApplicationTests {
	...
	public void getAllAirportsTest() {
		...
		Airport airport = new Airport();
		airport.setAirportId(1);
		airport.setAirportName("Nagpur International Airport");
		airport.setAirportCity("Nagpur");

		Airport airport1 = new Airport();
		airport1.setAirportId(2);
		airport1.setAirportName("Nagpur International Airport");
		airport1.setAirportCity("Nagpur");
	...
	public void setAllAirportDetailsTest() {
		...
		Airport airport1 = new Airport();
		airport1.setAirportId(2);
		airport1.setAirportName("Goa International Airport");
		airport1.setAirportCity("Goa");
